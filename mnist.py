...
def main(name: str, epochs: int, batch: int, count: bool, load: bool, minimum: float, maximum: float, rot: float):
    ...
    :param minimum: The minimum random scaling of the training dataset.
    :param maximum: The maximum random scaling of the training dataset.
    ...
    training_data = MNIST(
        ...
        transform=transforms.Compose([
            ...
            transforms.RandomResizedCrop(28, (minimum, maximum)),
...
if __name__ == '__main__':
    ...
    main(args["name"], args["epoch"], args["batch"], args["count"], args["load"], args["min"], args["max"], args["rot"])
